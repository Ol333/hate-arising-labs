...
Теперь идем по плану, **спроектированному в предыдущей лабораторной работе**.
...
* Если в процессе реализации вы отошли от запланированной диаграммы классов, поправьте ее согласно коду. Паттерн по заданию не должен потеряться.
