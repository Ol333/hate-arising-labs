...
1. По словесному описанию составить UML диаграмму классов (существительные должны превратиться в классы или поля классов, глаголы - в методы). **Классы должны быть не пустыми. Классы должны образовывать связный граф (от каждого класса можно добраться по линиям связи до каждого другого класса).**
