...
* Обеспечить считывание десятичного числа $A$ с консоли.
* Выполнить задание по варианту, **используя операции из таблицы выше**, а не работу со строками, массивами, коллекциями, перечислениями и проч.
* Программа должна выводить в консоль представление числа $A$ в двоичной форме и результат своей работы.
...
<table class="table table-hover border-primary table-bordered">
  ...
  <tbody>
    <tr>
      <th scope="row">1</th>
      <td>Определить, делится ли число $A$ на 2, не используя операцию нахождения остатка от деления (%)</td>
    </tr>
    <tr>
      <th scope="row">2</th>
      <td>Возвести 2 в степень $A$, не используя операции возведения в степень и умножения</td>
    </tr>
    <tr>
      <th scope="row">3 *</th>
      <td>Для натурального числа $A$ поcчитать количество единиц, стоящих на нечетных местах в его двоичной форме</td>
    </tr>
    <tr>
      <th scope="row">4</th>
      <td>Целочисленно разделить число $A$ на 4, не используя операцию деления</td>
    </tr>
    <tr>
      <th scope="row">5 *</th>
      <td>Для натурального числа $A$ поcчитать количество нулей, стоящих на нечетных местах в его двоичной форме</td>
    </tr>
    <tr>
      <th scope="row">6</th>
      <td>Умножить число $A$ на 2, не используя операции умножения и сложения</td>
    </tr>
    <tr>
      <th scope="row">7</th>
      <td>Целочисленно разделить число $A$ на 2, не используя операцию деления</td>
    </tr>
    <tr>
      <th scope="row">8 *</th>
      <td>Для натурального числа $A$ поcчитать количество нулей, стоящих на четных местах в его двоичной форме</td>
    </tr>
    <tr>
      <th scope="row">9</th>
      <td>Возвести 1024 в степень $(1/A)$, не используя операции возведения в степень, деления и умножения</td>
    </tr>
    <tr>
      <th scope="row">10</th>
      <td>Целочисленно разделить число $A$ на 8, не используя операцию деления</td>
    </tr>
    <tr>
      <th scope="row">11</th>
      <td>Определить, делится ли число $A$ на 4, не используя операцию нахождения остатка от деления (%)</td>
    </tr>
    <tr>
      <th scope="row">12 *</th>
      <td>Для натурального числа $A$ поcчитать количество единиц, стоящих на четных местах в его двоичной форме</td>
    </tr>
   </tbody>
</table>
</div>
...
## Задание 2. Шеснадцатиричный код результата операции

* Написать программу ***(всё еще используя логические операции, а не работу со строками)***, которая бы считывала с клавиатуры число $А_{16}$ в шестнадцатеричном формате и выводила значение параметров $Р_1$, $Р_2$, $Р_3$, ($Р_4$).
...
* То же, что и в предыдущем пункте, только считать $А_{16}$ из бинарного [файла]({{ site.baseurl }}/files/TIPiS/7lab_input3.bin) ( ←скачать).
* Циклически увеличить на единицу *(обнулить в случае переполнения)* параметры $Р_1$, $Р_2$, $Р_3$, ($Р_4$) и записать получившееся число $А_{16}'$ в новый бинарный файл. Показать, что записано именно то, что нужно. Размер файла должен быть 2 байта.
...
<table class="table table-hover border-primary table-bordered">
  ...
  <tbody>
    ...
    <tr>
      ...
      $P_1 = O_2...O_0$ – код команды (0: "сложение", 1: "вычитание", 2: "логическое И", 3: "логическое ИЛИ", 4: "логическое ИСКЛЮЧАЮЩЕЕ ИЛИ", 5..7: "не используются"),<br>
      $P_2 = V_3...V_0$ – адрес регистра-получателя,<br>
...
Тогда, для двенадцатого варианта код команды $P_1 =$ $100_2$ = 4 (выделенные цветом ячейки двоичного представления).
Это код команды "логическое ИСКЛЮЧАЮЩЕЕ ИЛИ".

<div class="row">
  <div class="col-lg-12">
   <ul class="list-unstyled">
     <li class="float-end">
       <button type="button" class="btn btn-outline-primary" onclick="window.location.href='#побитовые-операции';">Вверх</button>
     </li>
     <li  class="float-end">
