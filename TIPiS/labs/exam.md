...
2. *Как определить принцип работы Темной метки, имея в плену Пожирателя смерти, который не может открыть её секреты тому, кто их сам не знает?*

#### Практические вопросы (не входят в билеты)

* Как сделать интерфейс взаимодействия пользователя с программой дружественным? Выделите несколько последовательных вариантов интерфейса, в которых возможность пользователя допустить ошибку стремится к нулю.
* Как рассчитываются обобщенные оценки экспертов?
* Почему без приемлемо сформулированной постановки задачи оптимизации не стоит говорить об оптимальных параметрах?
* Где изображается БД на диаграмме IDEF0?
* Какое минимальное количество стрелок будет касаться блока хранилища данных в DFD?
* Как инвертировать последовательность битов в Python3?
* По какой причине считанные из файла 8 бит кодировки utf-8 сложно перевести в char?
