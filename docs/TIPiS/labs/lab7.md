...
1. Написать программу, в которой с помощью вводимых с клавиатуры параметров $Р_1$, $Р_2$, $Р_3$ и $Р_4$, формируется число $А_{16}$ и выводится на экран в шестнадцатеричном формате.
