...
 
## Задание 2
Скачать данные с температурой по городам с [Kaggle](https://www.kaggle.com/datasets/sudalairajkumar/daily-temperature-of-major-cities). Если очень не хочется регистрироваться на сайте, архив (2data.zip) можно взять в папке с заданием.
