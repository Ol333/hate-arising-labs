...
Имеются данные, представленные в виде текстового файла.
...
Числовые значения - это интервалы времени между ударами сердца в мс. Показания регистрировались в течение, приблизительно, 5 мин.
